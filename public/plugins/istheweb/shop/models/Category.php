...
class Category extends Model
{
     ...
     */
    public $table = 'istheweb_shop_categories';
    ...
    public $rules = [
        'name' => 'required',
        'slug' => 'required|between:3,64|unique:istheweb_shop_categories',
        'code' => 'unique:istheweb_shop_categories',
    ];
    ...
    public $hasOne = [];
    public $hasMany = [
        'children' => ['Istheweb\Shop\Models\Category', 'key' => 'parent_id'],
    ];
    public $belongsTo = [
        'parent' => ['Istheweb\Shop\Models\Category', 'key' => 'parent_id'],
    ];
